...
png(paste(prefix,".RNAseq.all.samples.heatmap.rld.png",sep=""),width=900,height=900)
...
pdf(paste(prefix,".all.samples.norep2.PCA.pdf",sep=""),width=9)
...
png(paste(prefix,".RNAseq.all.samples.heatmap.vsd.png",sep=""),width=900,height=900)
